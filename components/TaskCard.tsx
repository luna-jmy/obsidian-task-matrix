...
export const TaskCard: React.FC<TaskCardProps> = ({ task, onToggleStatus, onEdit, onDelete }) => {
  ...
  return (
    <div 
      ...
      `}
    >
      <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 flex gap-1 bg-white/80 backdrop-blur-sm rounded-lg shadow-sm border border-slate-100 p-0.5 transition-all z-10">
        <button 
