    ...
    >
      ...
      <div className="absolute top-1.5 right-1.5 flex gap-1 opacity-0 group-hover:opacity-100 transition-all z-10">
        ...
        <button 
          ...
          className={`p-1.5 rounded-lg transition-all ${confirmDelete ? 'text-white bg-red-500 shadow-sm' : 'text-slate-300 hover:text-red-600 hover:bg-red-50'}`}
          title={confirmDelete ? "Click again to confirm" : "Delete Task"}
        >
          {confirmDelete ? (
             <span className="text-[9px] font-black px-0.5 uppercase tracking-tighter">Sure?</span>
          ) : (
